...
const (
	ActorService_SendMessage_FullMethodName = "/aktorski_framework.ActorService/SendMessage"
)
...
type ActorServiceClient interface {
	SendMessage(ctx context.Context, in *RemoteEnvelope, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *actorServiceClient) SendMessage(ctx context.Context, in *RemoteEnvelope, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, ActorService_SendMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActorServiceServer interface {
	SendMessage(context.Context, *RemoteEnvelope) (*Empty, error)
...
func (UnimplementedActorServiceServer) SendMessage(context.Context, *RemoteEnvelope) (*Empty, error) {
...
func _ActorService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActorServiceServer).SendMessage(ctx, req.(*RemoteEnvelope))
	}
...
var ActorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aktorski_framework.ActorService",
